...
export function Install() {
  return (
    <section id="install" className="max-w-3xl mx-auto px-6 py-20">
      ...
      <a
        href={`https://github.com/frenchie4111/harness/releases/latest/download/Ness-${VERSION}-arm64.dmg`}
      ...
      >
        ...
        <div className="text-xs text-ink-500 font-mono">Ness-arm64.dmg</div>
      </a>

      <div className="mt-4 text-center">
        <a
          href={`https://github.com/frenchie4111/harness/releases/latest/download/Ness-${VERSION}.dmg`}
      ...
      <div className="mt-12 p-6 bg-ink-950 border border-ink-800 rounded-xl">
        ...
        <ol className="text-sm text-ink-500 space-y-2 list-decimal pl-5">
          <li>Pick a git repository when Ness asks.</li>
          <li>

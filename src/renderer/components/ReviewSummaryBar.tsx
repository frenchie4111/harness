import { ArrowLeft, MessageSquare, Send, Clipboard } from 'lucide-react'
...
export function ReviewSummaryBar({
  ...
  return (
    <div className="h-10 flex items-center gap-3 px-3 border-b border-border bg-panel shrink-0 drag-region">
